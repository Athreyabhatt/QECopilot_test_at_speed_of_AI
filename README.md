...
- **🚀 Optimized Dependencies** - Dynamic dependency installation based on automation stack, reducing build times and resource usage
- **🎛️ Framework Agnostic** - Automatically adapts to your chosen automation stack with minimal configuration
- **🔧 Customizable** - Modify instructions to match your coding standards
- **🛠️ Multi-Framework Support** - Supports Playwright, Selenium, WebdriverIO across TypeScript and Java
...
The workflows use **dynamic dependency installation** based on the `AUTOMATION_STACK` environment variable to optimize build performance:

- **Smart Installation**: Only installs dependencies required for your chosen automation stack
- **Reduced Build Times**: Avoids installing unnecessary packages for other frameworks
- **Resource Efficiency**: Minimizes CI/CD resource usage and costs
- **Clean Dependencies**: Maintains lean package.json/pom.xml files

**Example**: If you choose `playwright-typescript`, the workflow installs only Playwright + TypeScript dependencies, skipping Selenium, WebdriverIO, and Java dependencies.
